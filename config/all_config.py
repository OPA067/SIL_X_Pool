...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        parser.add_argument('--videos_dir', type=str, default='./videos/', help="Location of videos")
        parser.add_argument('--msrvtt_train_file', type=str, default='9k')
        parser.add_argument('--num_frames', type=int, default=12)
        parser.add_argument('--num_captions', type=int, default=6)
        ...
        # model parameters
        parser.add_argument('--arch', type=str, default='clip_stochastic')
        ...
        parser.add_argument('--batch_size_split', type=int, default=10, help="split integer for batch-wise bmm, larger to save more memory. Default=None, automatically split into 10-sample batches")
        ...
        parser.add_argument('--save_memory_mode', action='store_true', default=True, help='if specified, will use sim_matrix_inference_light_allops() at eval no matter of the dataset')
        ...
        parser.add_argument('--DSL', action='store_true', default=True, help='If specified, will normalize use DSL')
